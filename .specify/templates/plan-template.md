...
**Language/Version**: [e.g., Python 3.11, Node.js 20, or NEEDS CLARIFICATION]
**Primary Dependencies**: [e.g., file system watchers, markdown parsers, or NEEDS CLARIFICATION]
...
**Performance Goals**: [e.g., process task file in <5s, or NEEDS CLARIFICATION]
**Constraints**: No external APIs, no network calls, vault-only operations, manual triggers only
**Scale/Scope**: [e.g., 100 tasks/day, 1000 files in vault, or NEEDS CLARIFICATION]
...
- [ ] All operations confined to Obsidian vault directory
- [ ] No external API calls or network operations
- [ ] No autonomous background processes
- [ ] State transitions via folder movement only (/Inbox → /Needs_Action → /Plans → /Done)
- [ ] All data stored as Markdown files
- [ ] Manual trigger model enforced (no auto-processing)
